...
async function runAdvancedSimulation(cardId, deltaPct) {
...
async function executeActionInOdoo(cardId, action) {
    switch (cardId) {
        case 'opp-001':
...
function generateRecommendations(cardId, deltaPct, results) {
...
//# sourceMappingURL=pulse.routes.js.map