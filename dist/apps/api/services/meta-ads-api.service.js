...
exports.MetaAdsApiService = void 0;
const tslib_1 = require("tslib");
const common_1 = require("@nestjs/common");
let MetaAdsApiService = class MetaAdsApiService {
    constructor() {
    ...
    async setupPixelTracking(pixelId, websiteUrl) {
    ...
    async setupConversionsApi(pixelId, accessToken) {
    ...
    calculateConversionRate(clicks, leads) {
        if (!clicks || !leads)
            return 0;
        return (leads / clicks) * 100;
    }
    async generateUTMLinks(baseUrl, campaign, source = 'facebook') {
    ...
    async exportToBigQuery(campaignData) {
...
exports.MetaAdsApiService = MetaAdsApiService;
exports.MetaAdsApiService = MetaAdsApiService = tslib_1.__decorate([
    (0, common_1.Injectable)()
], MetaAdsApiService);
//# sourceMappingURL=meta-ads-api.service.js.map