...
class NLPProcessor {
    constructor() {
        ...
        this.entityTypes = ['PERSON', 'ORGANIZATION', 'LOCATION', 'DATE', 'MONEY', 'EMAIL', 'PHONE'];
    }
    async processText(text, language = 'auto') {
