...
exports.OdooCRMTool = void 0;
class OdooCRMTool {
    constructor() {
        this.name = 'odoo-crm';
        this.description = 'التكامل مع نظام Odoo CRM لإدارة العملاء المحتملين والفرص التجارية';
    }
    ...
    async searchCustomers(query) {
        ...
        const filteredCustomers = customers.filter(customer => customer.name.includes(query) ||
...
exports.OdooCRMTool = OdooCRMTool;
//# sourceMappingURL=odoo-crm.tool.js.map