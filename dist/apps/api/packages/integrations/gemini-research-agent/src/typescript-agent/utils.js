...
exports.getResearchTopic = getResearchTopic;
exports.resolveUrls = resolveUrls;
exports.insertCitationMarkers = insertCitationMarkers;
exports.getCitations = getCitations;
exports.getCurrentDate = getCurrentDate;
exports.cleanText = cleanText;
exports.evaluateSourceQuality = evaluateSourceQuality;
 ...
 */
function resolveUrls(urlsToResolve, id) {
 ...
 */
function insertCitationMarkers(text, citationsList) {
 ...
 */
function getCitations(response, resolvedUrlsMap) {
    const citations = [];
