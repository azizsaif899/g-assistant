...
exports.AmazonExecutor = void 0;
const tslib_1 = require("tslib");
const ai_fixer_1 = require("./ai-fixer");
...
class AmazonExecutor {
    ...
    parseTasksFromReview(review) {
        if (!review.priorities)
            return [];
        return review.priorities.map((priority, index) => ({
    ...
    requestClarification(task) {
        ...
        const clarificationPath = path.join(this.reportsDir, `clarification_${task.taskId}.json`);
        fs.writeFileSync(clarificationPath, JSON.stringify(clarificationRequest, null, 2));
    ...
    async testChanges(task) {
        ...
        try {
            ...
            if (project) {
                ...
                (0, child_process_1.execSync)(`nx test ${project}`, {
                    cwd: this.projectRoot,
                    stdio: 'pipe'
                });
                (0, child_process_1.execSync)(`nx lint ${project}`, {
                    cwd: this.projectRoot,
                    stdio: 'pipe'
                });
            }
    ...
    // إنشاء تقرير GitHub
    async generateGitHubReport(tasks, results) {
...
exports.AmazonExecutor = AmazonExecutor;
// تشغيل مباشر
...
//# sourceMappingURL=amazon-executor.js.map