...
exports.LiveSimulator = void 0;
const tslib_1 = require("tslib");
const react_1 = tslib_1.__importStar(require("react"));
const LiveSimulator = ({ cardId, title, description, baseMetrics, onSimulate }) => {
    const [sliderValue, setSliderValue] = (0, react_1.useState)(0);
    const [simulationResults, setSimulationResults] = (0, react_1.useState)([]);
    ...
    // حساب التأثير المحلي
    const calculateImpact = (changePct, metrics) => {
        const results = [];
    ...
    return (<div className="live-simulator" style={{
            background: 'white',
      ...
      <div style={{ marginBottom: '24px' }}>
        ...
        <input type="range" min="-50" max="100" value={sliderValue} onChange={(e) => setSliderValue(Number(e.target.value))} style={{
            width: '100%',
            height: '6px',
            borderRadius: '3px',
            background: '#e0e0e0',
      ...
      {/* Results */}
      {simulationResults.length > 0 && (<div>
          <h4 style={{
                fontSize: '14px',
                fontWeight: '600',
                color: '#333',
          ...
          <div style={{
            ...
            {simulationResults.map((result) => (<div key={result.metric} style={{
                    background: '#f8f9fa',
                    padding: '12px',
                    borderRadius: '8px',
      ...
      {/* Reset button */}
      {sliderValue !== 0 && (<button onClick={() => setSliderValue(0)} style={{
                marginTop: '16px',
                padding: '8px 16px',
                background: '#f5f5f5',
...
exports.LiveSimulator = LiveSimulator;
//# sourceMappingURL=LiveSimulator.js.map