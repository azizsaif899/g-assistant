...
exports.NaturalQueryBar = void 0;
const tslib_1 = require("tslib");
const react_1 = tslib_1.__importStar(require("react"));
const NaturalQueryBar = ({ onQuery, placeholder = "اسأل أي شيء عن بياناتك..." }) => {
    ...
    return (<div className="natural-query-bar" style={{ width: '100%' }}>
      {/* شريط البحث الرئيسي */}
      <form onSubmit={handleSubmit} style={{ position: 'relative' }}>
        <div style={{
          ...
          <input type="text" value={query} onChange={(e) => setQuery(e.target.value)} placeholder={placeholder} disabled={isLoading} style={{
            flex: 1,
            border: 'none',
            outline: 'none',
            fontSize: '16px',
      ...
      <div style={{ marginTop: '16px' }}>
        ...
        <div style={{
          ...
          {suggestedQueries.map((suggestion, index) => (<button key={index} onClick={() => {
                setQuery(suggestion);
                onQuery(suggestion);
            }} style={{
                background: '#f5f5f5',
...
exports.NaturalQueryBar = NaturalQueryBar;
//# sourceMappingURL=NaturalQueryBar.js.map