...
const AgentDashboard = () => {
    ...
    return (<div className="agent-dashboard" style={{ padding: '20px' }}>
      <div style={{
            display: 'flex',
      ...
      <div style={{
        ...
        {agents.map((agent) => (<div key={agent.id} style={{
                background: 'white',
                border: '1px solid #e0e0e0',
                borderRadius: '12px',
                padding: '20px',
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: '4px' }}>
                {agent.status === 'active' ? (<button onClick={() => handleAgentAction(agent.id, 'stop')} style={{
                    padding: '4px 8px',
                    background: '#f44336',
                    color: 'white',
                    border: 'none',
                    ...
                    إيقاف
                  </button>) : (<button onClick={() => handleAgentAction(agent.id, 'start')} style={{
                    padding: '4px 8px',
                    background: '#4CAF50',
                    color: 'white',
                    border: 'none',
            ...
            <div style={{
              ...
              {agent.kpis.meetingsScheduled > 0 && (<div>
