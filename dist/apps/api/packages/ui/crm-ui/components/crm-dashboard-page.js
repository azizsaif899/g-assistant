...
const CRMDashboard = () => {
    ...
    return (<div style={{ padding: '20px' }}>
      ...
      <div style={{ marginBottom: '20px' }}>
        <button onClick={syncWithOdoo} style={{
            padding: '10px 20px',
            marginRight: '10px',
        ...
        <button onClick={syncWithMeta} style={{
            padding: '10px 20px',
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', backgroundColor: 'white' }}>
        ...
        <tbody>
          {leads.map((lead) => (<tr key={lead.id} style={{ borderBottom: '1px solid #dee2e6' }}>
...
//# sourceMappingURL=crm-dashboard-page.js.map