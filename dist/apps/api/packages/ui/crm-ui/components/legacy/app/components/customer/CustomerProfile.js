...
const CustomerHeader_1 = require("./CustomerHeader");
const UnifiedTimeline_1 = require("../timeline/UnifiedTimeline");
const InsightsPanel_1 = require("../insights/InsightsPanel");
const useCustomerData_1 = require("../../hooks/useCustomerData");
function CustomerProfile({ customerId }) {
    const { customer, isLoading } = (0, useCustomerData_1.useCustomerData)(customerId);
    if (isLoading) {
    ...
    return (<div className="min-h-screen bg-gray-50">
      <CustomerHeader_1.CustomerHeader customer={customer}/>
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6 sticky top-6">
              ...
              <div className="mt-6 pt-6 border-t">
                ...
                <div className="space-y-2">
                  {customer.activeDeals?.map(deal => (<div key={deal.id} className="flex justify-between items-center">
          ...
          <div className="lg:col-span-6">
            <UnifiedTimeline_1.UnifiedTimeline customerId={customerId}/>
          </div>

          {/* العمود الأيمن: لوحة الرؤى والتحليلات */}
          <div className="lg:col-span-3">
            <InsightsPanel_1.InsightsPanel customerId={customerId}/>
          </div>
        </div>
      </div>
    </div>);
