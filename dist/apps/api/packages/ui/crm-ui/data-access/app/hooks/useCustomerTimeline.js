...
exports.useCustomerTimeline = useCustomerTimeline;
const react_query_1 = require("@tanstack/react-query");
function useCustomerTimeline(customerId, filter = 'all') {
    const { data: timeline = [], isLoading, error } = (0, react_query_1.useQuery)({
...
//# sourceMappingURL=useCustomerTimeline.js.map