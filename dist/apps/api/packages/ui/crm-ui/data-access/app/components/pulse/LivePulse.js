...
exports.LivePulse = LivePulse;
const framer_motion_1 = require("framer-motion");
const lucide_react_1 = require("lucide-react");
const useLivePulse_1 = require("../../hooks/useLivePulse");
function LivePulse() {
    const { metrics, isLoading, lastUpdate, isConnected, healthStatus, revenueProgress, activeAlerts } = (0, useLivePulse_1.useLivePulse)();
    if (isLoading) {
    ...
    return (<div className="bg-white rounded-lg shadow-sm border">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="relative">
              ...
              <framer_motion_1.motion.div animate={{ scale: [1, 1.2, 1] }} transition={{ duration: 2, repeat: Infinity }} className={`absolute -top-1 -right-1 w-3 h-3 rounded-full ${isConnected ? 'bg-green-500' : 'bg-red-500'}`}/>
            </div>
            <div>
          ...
          <div className="flex items-center space-x-3">
            {activeAlerts > 0 && (<div className="flex items-center space-x-1 text-red-600">
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* الإيرادات */}
          <framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="relative overflow-hidden">
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4">
              <div className="flex items-center justify-between mb-3">
                <lucide_react_1.DollarSign className="w-8 h-8 text-green-600"/>
                <div className={`text-xs px-2 py-1 rounded-full ${metrics.revenue.trend === 'up'
            ...
            : 'bg-red-200 text-red-800'}`}>
              ...
              <div className="space-y-2">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <framer_motion_1.motion.div initial={{ width: 0 }} animate={{ width: `${revenueProgress}%` }} transition={{ duration: 1 }} className="bg-green-500 h-2 rounded-full"/>
                </div>
              </div>
            </div>
          ...
          <framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4">
              <div className="flex items-center justify-between mb-3">
                <lucide_react_1.TrendingUp className="w-8 h-8 text-blue-600"/>
          ...
          <framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-4">
              <div className="flex items-center justify-between mb-3">
                <lucide_react_1.Zap className="w-8 h-8 text-orange-600"/>
              ...
              <div className="space-y-2">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <framer_motion_1.motion.div initial={{ width: 0 }} animate={{ width: `${metrics.team.activity}%` }} transition={{ duration: 1, delay: 0.5 }} className="bg-orange-500 h-2 rounded-full"/>
                </div>
              </div>
            </div>
          </framer_motion_1.motion.div>
...
//# sourceMappingURL=LivePulse.js.map