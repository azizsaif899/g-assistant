...
const AIInsights = () => {
    ...
    const [selectedInsight, setSelectedInsight] = (0, react_1.useState)(null);
    const geminiClient = new core_logic_1.GeminiClient({
...
قدم تحليلاً مختصراً ومفيداً مع توصية للتحسين.`;
    ...
    const generateUsageInsight = async () => {
...
ما هي الاتجاهات والفرص؟`;
    ...
    const generatePredictionInsight = async () => {
        return {
            id: 'pred-001',
            type: 'prediction',
            title: 'توقعات النمو',
    ...
    if (isLoading) {
        return (<div className="ai-insights-loading">
    ...
    return (<div className="ai-insights-container">
      ...
      {metrics && (<div className="metrics-summary">
      ...
      <div className="insights-grid">
        {insights.map((insight) => (<div key={insight.id} className="insight-card" onClick={() => setSelectedInsight(insight)}>
            <div className="insight-header">
              <span className="insight-icon">{getInsightIcon(insight.type)}</span>
              <div className="insight-meta">
                <h3>{insight.title}</h3>
                <div className="insight-badges">
                  <span className="impact-badge" style={{ backgroundColor: getImpactColor(insight.impact) }}>
                    {insight.impact}
                  </span>
      ...
      {selectedInsight && (<div className="insight-modal" onClick={() => setSelectedInsight(null)}>
