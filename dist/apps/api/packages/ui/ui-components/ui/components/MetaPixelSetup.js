...
exports.MetaPixelSetup = void 0;
const tslib_1 = require("tslib");
const react_1 = tslib_1.__importStar(require("react"));
const MetaPixelSetup = () => {
    const [pixelId, setPixelId] = (0, react_1.useState)('');
    const [website, setWebsite] = (0, react_1.useState)('');
    const [pixelCode, setPixelCode] = (0, react_1.useState)('');
    const [utmLink, setUtmLink] = (0, react_1.useState)('');
    const [campaignName, setCampaignName] = (0, react_1.useState)('');
    ...
    return (<div style={{ padding: '20px', maxWidth: '800px' }}>
      ...
      <div style={{ marginBottom: '30px', padding: '20px', backgroundColor: '#f8f9fa', borderRadius: '8px' }}>
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          <input type="text" value={pixelId} onChange={(e) => setPixelId(e.target.value)} placeholder="123456789012345" style={{ width: '100%', padding: '8px', borderRadius: '4px', border: '1px solid #ddd' }}/>
        </div>
        <div style={{ marginBottom: '15px' }}>
          <label style={{ display: 'block', marginBottom: '5px' }}>رابط الموقع:</label>
          <input type="url" value={website} onChange={(e) => setWebsite(e.target.value)} placeholder="https://your-website.com" style={{ width: '100%', padding: '8px', borderRadius: '4px', border: '1px solid #ddd' }}/>
        </div>
        <button onClick={generatePixelCode} style={{
            padding: '10px 20px',
        ...
        {pixelCode && (<div style={{ marginTop: '20px' }}>
            ...
            <button onClick={() => copyToClipboard(pixelCode)} style={{
                marginTop: '10px',
                padding: '5px 15px',
      ...
      <div style={{ marginBottom: '30px', padding: '20px', backgroundColor: '#e3f2fd', borderRadius: '8px' }}>
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          <input type="text" value={campaignName} onChange={(e) => setCampaignName(e.target.value)} placeholder="حملة-الخدمات-التقنية" style={{ width: '100%', padding: '8px', borderRadius: '4px', border: '1px solid #ddd' }}/>
        </div>
        <button onClick={generateUTMLink} style={{
            padding: '10px 20px',
        ...
        {utmLink && (<div style={{ marginTop: '20px' }}>
            <h4>رابط UTM:</h4>
            <div style={{
                backgroundColor: '#f1f3f4',
                padding: '15px',
            ...
            <button onClick={() => copyToClipboard(utmLink)} style={{
                marginTop: '10px',
                padding: '5px 15px',
                backgroundColor: '#4CAF50',
                color: 'white',
...
exports.MetaPixelSetup = MetaPixelSetup;
//# sourceMappingURL=MetaPixelSetup.js.map