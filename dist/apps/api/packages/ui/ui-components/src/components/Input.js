...
exports.Input = (0, react_1.forwardRef)(({ className = '', label, error, ...props }, ref) => {
    ...
    return (<div className="space-y-2">
        ...
        <input ref={ref} className={`${baseClasses} ${error ? 'border-red-500 focus:ring-red-500' : ''} ${className}`} {...props}/>
